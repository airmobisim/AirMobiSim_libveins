...
ifeq ($(wildcard out/config.py),)
    ...
    ADDL_TARGETS += bin/veins_libairmobisim_run
endif
...
bin/veins_libairmobisim_run: src/scripts/veins_libairmobisim_run.in.py out/config.py
...
cleanall: clean
	rm -f src/Makefile
	rm -f out/config.py
	rm -f bin/veins_libairmobisim_run
